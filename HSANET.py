...
class LDCF:
    ...
    def compile_model(self):
        ...
        # _model.compile(optimizer=self.optimizer(lr=self.lr, decay=self.decay), loss='mean_absolute_percentage_error')
    ...
    def build_model(self, num_users, num_item, layers, reg_layers):
        ...
        #m+n *1.5
        x = cnn1(512, 12)(inputs)
        # x = bn()(x)
        x = Activation('relu')(x)
        # M+N
        x2 = cnn1(512, 8,strides=8)(inputs)
        # x2 = bn()(x2)
        x2 = Activation('relu')(x2)
        #M
        x3 = cnn1(512, 3, strides=8)(inputs)
        # x3 = bn()(x3)
        x3 = Activation('relu')(x3)
        # m+n *2
        x5 = cnn1(512, 16)(inputs)
        # x5 = bn()(x5)
        x5 = Activation('relu')(x5)
        x4 = concatenate([x,x2,x3,x5], axis=1)
        x = Flatten()(x4)
        x = Dense(1024)(x)
        # x = bn()(x)
        x = Activation('relu')(x)
